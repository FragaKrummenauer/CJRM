...
function nameDog (dog) {
  return dog.name === "Zequinha";
}

console.log(dogs.find(nameDog))
...
const mainTitle = document.querySelector('body > section > article > h1')
...
const nodeListTitle = document.querySelectorAll('.secondary-title')

console.log(nodeListTitle) 