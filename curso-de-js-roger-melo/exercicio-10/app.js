...
*/
  ...
  let cat = {
    ...
    age: 5,
    color: 'Blue',
    bestFriends: ['YellowCat', 'HorseCaramelo' ],
    sound: function () {
...
*/
  ...
  let mensageCat = ` Até aqui, o objeto "cat" possui as seguintes propriedades e valores: "name", que recebeu " ${cat.name} ", "age", que recebeu " ${cat.age} ", "color", que recebeu " ${cat.color} ", "bestFriends", que recebeu um array com os itens " ${cat.bestFriends[0]} " e " ${cat.bestFriends[1]} ", e "sound", que recebeu uma função que retorna " ${cat.sound()} ".`

  console.log(mensageCat)
...
let dog = {
  ...
  age: 3,
  color: 'Black',
  bestFriends: ['Elephant', 'Giraffe', 'Pig'],
  sound: () => 'runrunrunrun'
}
