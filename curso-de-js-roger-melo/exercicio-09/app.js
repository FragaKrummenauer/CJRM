...
// Eduardo Krummenauer
const sayPhrashInLowerCase = () => 'CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO'

const phrashToLowerCase = sayPhrashInLowerCase().toLowerCase()

console.log(phrashToLowerCase)
...
const logName = () => {
  console.log('Eduardo Krummenauer')
}
...
const getLikesMessage = (names = []) => {
  ...
  switch (names.length) {
    ...
    case 2: 
      return `${firstName} e ${secondNames} curtiram isso`
    case 3: 
      return `${firstName}, ${secondNames} e ${thirdName} curtiram isso`
    default:
      return `${firstName}, ${secondNames} e mais ${totalNamesMinusTwo} pessoas curtiram isso`
  }
}
